...
$(".submit").click(function(e){
    ...
    if (valid){
        var params = {"nama": $("#username").val(), "nomor": $("#phonenumber").val(), "email": $("#email").val(), "event": $(".dropdown-toggle").text()};
        $.ajax({
            accept: "application/json",
            contentType: "application/json; charset=utf-8",
            url: "https://myownproject3-default-rtdb.asia-southeast1.firebasedatabase.app/.json",
            type: "POST",
